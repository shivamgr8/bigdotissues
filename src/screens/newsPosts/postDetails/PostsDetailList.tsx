...
const PostsDetailList = (props: any) => {
  ...
  //     // webviewRef.current.current?.scrollTo(
  ...
  //   sveRecentCategory(postData[indexRef.current]?.categoryId);
  // }, [sw]);
  ...
  const renderItem = useCallback(({ item, index }: any) => {
    return (
      <PostDetailScreen
        ...
        // handleFlatListScroll={handleFlatListScroll}
  ...
  if (postData && postData.length) {
    return (
      ...
      //   }}
      // >
      //   <Animated.View style={{ flex: 1, zIndex: 99, borderWidth: 1 }}>
